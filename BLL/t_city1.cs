...
namespace System.BLL {
	 	//t_city1
		public partial class t_city1
	{
   		     
		private readonly System.DAL.t_city1 dal=new System.DAL.t_city1();
		public t_city1()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(System.Model.t_city1 model)
		{
						dal.Add(model);
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.t_city1 model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.t_city1 GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_city1 GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_city1Model-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_city1)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_city1> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_city1> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_city1> DataTableToList(DataTable dt)
		{
			List<System.Model.t_city1> modelList = new List<System.Model.t_city1>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_city1 model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_city1();					
