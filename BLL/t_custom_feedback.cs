...
namespace System.BLL {
	 	//t_custom_feedback
		public partial class t_custom_feedback
	{
   		     
		private readonly System.DAL.t_custom_feedback dal=new System.DAL.t_custom_feedback();
		public t_custom_feedback()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_custom_feedback GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_custom_feedbackModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_custom_feedback)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_custom_feedback> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_custom_feedback> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
