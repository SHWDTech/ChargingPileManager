...
namespace System.BLL {
		...
		public partial class t_permissions
	{
		...
		private readonly System.DAL.t_permissions dal=new System.DAL.t_permissions();
		...
		{
			return dal.Exists(permissionsId);
		}
		...
		public bool Delete(string permissionsId)
		{
			...
			return dal.Delete(permissionsId);
		}
		...
		public System.Model.t_permissions GetModel(string permissionsId)
		{
			...
			return dal.GetModel(permissionsId);
		}

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_permissions GetModelByCache(string permissionsId)
		//{
		//	
		//	string CacheKey = "t_permissionsModel-" + permissionsId;
		//	object objModel = Maticsoft.Common.DataCache.GetCache(CacheKey);
		//	if (objModel == null)
		//	{
		//		try
		//		{
		//			objModel = dal.GetModel(permissionsId);
		//			if (objModel != null)
		//			{
		...
		//		catch{}
		//	}
		//	return (System.Model.t_permissions)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_permissions> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_permissions> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_permissions> DataTableToList(DataTable dt)
		{
			List<System.Model.t_permissions> modelList = new List<System.Model.t_permissions>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_permissions model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_permissions();					
																	model.permissionsId= dt.Rows[n]["permissionsId"].ToString();
																																model.name= dt.Rows[n]["name"].ToString();
																																model.classificationId= dt.Rows[n]["classificationId"].ToString();
