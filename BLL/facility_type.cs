...
namespace System.BLL {
		...
		public partial class facility_type
	{
		...
		private readonly System.DAL.facility_type dal=new System.DAL.facility_type();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.facility_type GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "facility_typeModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.facility_type)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.facility_type> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.facility_type> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
