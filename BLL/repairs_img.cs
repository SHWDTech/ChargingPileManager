...
namespace System.BLL {
		...
		public partial class repairs_img
	{
		...
		private readonly System.DAL.repairs_img dal=new System.DAL.repairs_img();
		public repairs_img()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.repairs_img GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "repairs_imgModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.repairs_img)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.repairs_img> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.repairs_img> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.repairs_img> DataTableToList(DataTable dt)
		{
			List<System.Model.repairs_img> modelList = new List<System.Model.repairs_img>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.repairs_img model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.repairs_img();					
																												...
																												if(dt.Rows[n]["pudate"].ToString()!="")
				{
					model.pudate=DateTime.Parse(dt.Rows[n]["pudate"].ToString());
																																				...
																																				model.guishu= dt.Rows[n]["guishu"].ToString();
																																model.uploader= dt.Rows[n]["uploader"].ToString();
