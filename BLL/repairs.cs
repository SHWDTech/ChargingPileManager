...
namespace System.BLL {
		...
		public partial class repairs
	{
		...
		private readonly System.DAL.repairs dal=new System.DAL.repairs();
		public repairs()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.repairs GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "repairsModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.repairs)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.repairs> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.repairs> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
