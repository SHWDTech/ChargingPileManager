...
namespace System.BLL {
		...
		public partial class Member_Charge_Withdraw
	{
		...
		private readonly System.DAL.Member_Charge_Withdraw dal=new System.DAL.Member_Charge_Withdraw();
		public Member_Charge_Withdraw()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.Member_Charge_Withdraw GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "Member_Charge_WithdrawModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.Member_Charge_Withdraw)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.Member_Charge_Withdraw> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.Member_Charge_Withdraw> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.Member_Charge_Withdraw> DataTableToList(DataTable dt)
		{
			List<System.Model.Member_Charge_Withdraw> modelList = new List<System.Model.Member_Charge_Withdraw>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.Member_Charge_Withdraw model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.Member_Charge_Withdraw();					
																																...
																																if(dt.Rows[n]["paystatus"].ToString()!="")
				{
					model.paystatus=int.Parse(dt.Rows[n]["paystatus"].ToString());
																																...
																																model.statusname= dt.Rows[n]["statusname"].ToString();
																												if(dt.Rows[n]["types"].ToString()!="")
				{
					model.types=int.Parse(dt.Rows[n]["types"].ToString());
				}
																																				model.tpSerialNumber= dt.Rows[n]["tpSerialNumber"].ToString();
																												if(dt.Rows[n]["moneyes"].ToString()!="")
				{
					model.moneyes=decimal.Parse(dt.Rows[n]["moneyes"].ToString());
				}
