...
namespace System.BLL {
		...
		public partial class t_content
	{
		...
		private readonly System.DAL.t_content dal=new System.DAL.t_content();
		public t_content()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(System.Model.t_content model)
		{
						dal.Add(model);
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.t_content model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.t_content GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_content GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_contentModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_content)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_content> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_content> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_content> DataTableToList(DataTable dt)
		{
			List<System.Model.t_content> modelList = new List<System.Model.t_content>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_content model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_content();					
