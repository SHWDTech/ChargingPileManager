...
namespace System.BLL {
		...
		public partial class t_img
	{
		...
		private readonly System.DAL.t_img dal=new System.DAL.t_img();
		public t_img()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_img GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_imgModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_img)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_img> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_img> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
