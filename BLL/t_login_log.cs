...
namespace System.BLL {
		...
		public partial class t_login_log
	{
		...
		private readonly System.DAL.t_login_log dal=new System.DAL.t_login_log();
		public t_login_log()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_login_log GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_login_logModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_login_log)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_login_log> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_login_log> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_login_log> DataTableToList(DataTable dt)
		{
			List<System.Model.t_login_log> modelList = new List<System.Model.t_login_log>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_login_log model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_login_log();					
													if(dt.Rows[n]["id"].ToString()!="")
				{
					model.id=int.Parse(dt.Rows[n]["id"].ToString());
				}
																																				model.phone= dt.Rows[n]["phone"].ToString();
																																model.authcode= dt.Rows[n]["authcode"].ToString();
