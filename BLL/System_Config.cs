...
namespace System.BLL {
		...
		public partial class System_Config
	{
		...
		private readonly System.DAL.System_Config dal=new System.DAL.System_Config();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(System.Model.System_Config model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.System_Config model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.System_Config GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.System_Config GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "System_ConfigModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.System_Config)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.System_Config> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.System_Config> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.System_Config> DataTableToList(DataTable dt)
		{
			List<System.Model.System_Config> modelList = new List<System.Model.System_Config>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.System_Config model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.System_Config();					
