...
namespace System.BLL {
		...
		public partial class t_msg
	{
		...
		private readonly System.DAL.t_msg dal=new System.DAL.t_msg();
		public t_msg()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(System.Model.t_msg model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.t_msg model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.t_msg GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_msg GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_msgModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_msg)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_msg> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_msg> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_msg> DataTableToList(DataTable dt)
		{
			List<System.Model.t_msg> modelList = new List<System.Model.t_msg>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_msg model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_msg();					
