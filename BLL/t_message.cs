...
namespace System.BLL {
		...
		public partial class t_message
	{
		...
		private readonly System.DAL.t_message dal=new System.DAL.t_message();
		public t_message()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(System.Model.t_message model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.t_message model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.t_message GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_message GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_messageModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_message)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_message> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_message> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_message> DataTableToList(DataTable dt)
		{
			List<System.Model.t_message> modelList = new List<System.Model.t_message>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_message model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_message();					
