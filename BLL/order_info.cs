...
namespace System.BLL {
		...
		public partial class order_info
	{
		...
		private readonly System.DAL.order_info dal=new System.DAL.order_info();
		public order_info()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.order_info GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "order_infoModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.order_info)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.order_info> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.order_info> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.order_info> DataTableToList(DataTable dt)
		{
			List<System.Model.order_info> modelList = new List<System.Model.order_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.order_info model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.order_info();					
																																...
																																if(dt.Rows[n]["types"].ToString()!="")
				{
					model.types=int.Parse(dt.Rows[n]["types"].ToString());
																																...
																																if(dt.Rows[n]["stippleid"].ToString()!="")
				{
					model.stippleid=int.Parse(dt.Rows[n]["stippleid"].ToString());
				}
