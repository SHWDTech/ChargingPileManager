...
namespace System.BLL {
	 	//t_custom_search
		public partial class t_custom_search
	{
   		     
		private readonly System.DAL.t_custom_search dal=new System.DAL.t_custom_search();
		public t_custom_search()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_custom_search GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_custom_searchModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_custom_search)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_custom_search> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_custom_search> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
