...
namespace System.BLL {
		...
		public partial class facility_stipple
	{
		...
		private readonly System.DAL.facility_stipple dal=new System.DAL.facility_stipple();
		public facility_stipple()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.facility_stipple GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "facility_stippleModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.facility_stipple)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.facility_stipple> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.facility_stipple> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
