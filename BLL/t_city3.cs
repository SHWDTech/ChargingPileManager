...
namespace System.BLL {
	 	//t_city3
		public partial class t_city3
	{
   		     
		private readonly System.DAL.t_city3 dal=new System.DAL.t_city3();
		public t_city3()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public void  Add(System.Model.t_city3 model)
		{
						dal.Add(model);
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.t_city3 model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.t_city3 GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_city3 GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_city3Model-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_city3)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_city3> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_city3> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_city3> DataTableToList(DataTable dt)
		{
			List<System.Model.t_city3> modelList = new List<System.Model.t_city3>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_city3 model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_city3();					
