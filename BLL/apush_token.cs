...
namespace System.BLL {
	 	//apush_token
		public partial class apush_token
	{
   		     
		private readonly System.DAL.apush_token dal=new System.DAL.apush_token();
		public apush_token()
		{}
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(System.Model.apush_token model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(System.Model.apush_token model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public System.Model.apush_token GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.apush_token GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "apush_tokenModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.apush_token)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.apush_token> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.apush_token> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.apush_token> DataTableToList(DataTable dt)
		{
			List<System.Model.apush_token> modelList = new List<System.Model.apush_token>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.apush_token model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.apush_token();					
																												...
																												if(dt.Rows[n]["clientType"].ToString()!="")
				{
					model.clientType=int.Parse(dt.Rows[n]["clientType"].ToString());
																												...
																												if(dt.Rows[n]["isstartusing"].ToString()!="")
				{
					model.isstartusing=int.Parse(dt.Rows[n]["isstartusing"].ToString());
				}
