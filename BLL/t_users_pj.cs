...
namespace System.BLL {
		...
		public partial class t_users_pj
	{
		...
		private readonly System.DAL.t_users_pj dal=new System.DAL.t_users_pj();
		public t_users_pj()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public System.Model.t_users_pj GetModelByCache(int id)
		//{
		//	
		//	string CacheKey = "t_users_pjModel-" + id;
		...
		//		catch{}
		//	}
		//	return (System.Model.t_users_pj)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_users_pj> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<System.Model.t_users_pj> GetModelList(string strWhere, params SqlParameter[] parameters)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<System.Model.t_users_pj> DataTableToList(DataTable dt)
		{
			List<System.Model.t_users_pj> modelList = new List<System.Model.t_users_pj>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				System.Model.t_users_pj model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new System.Model.t_users_pj();					
													if(dt.Rows[n]["id"].ToString()!="")
				{
					model.id=int.Parse(dt.Rows[n]["id"].ToString());
																																...
																																model.fwtd= dt.Rows[n]["fwtd"].ToString();
																																model.wlsd= dt.Rows[n]["wlsd"].ToString();
																																model.texts= dt.Rows[n]["texts"].ToString();
																												if(dt.Rows[n]["evaluate"].ToString()!="")
				{
					model.evaluate=int.Parse(dt.Rows[n]["evaluate"].ToString());
				}
