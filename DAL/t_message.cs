...
namespace System.DAL  
{
		...
		public partial class t_message
	{
		...
		public int Add(System.Model.t_message model)
		{
            ...
            strSql.Append("title,memo,pudate,customId,types");
...
SqlParameter[] parameters = {
		...
		public System.Model.t_message GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, title, memo, pudate, customId, types  ");			
			...
			System.Model.t_message model=new System.Model.t_message();
        ...
        public DataSet GetList(string strWhere, params SqlParameter[] parameters)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM t_message T");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM t_message T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
