...
namespace System.DAL  
{
		...
		public partial class System_Config
	{
		...
		public int Add(System.Model.System_Config model)
		{
            ...
            strSql.Append("type,toid,value,msg");
...
SqlParameter[] parameters = {
		...
		public System.Model.System_Config GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, type, toid, value, msg  ");			
			...
			System.Model.System_Config model=new System.Model.System_Config();
        ...
        public DataSet GetList(string strWhere, params SqlParameter[] parameters)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM System_Config T");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM System_Config T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
