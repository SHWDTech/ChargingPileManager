...
namespace System.DAL  
{
		...
		public partial class apush_token
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "apush_token");
        }
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from apush_token");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into apush_token(");			
            strSql.Append("token,device,clientType,customId,isstartusing");
			...
			SqlParameter[] parameters = {
                        ...
                        new SqlParameter("@isstartusing", SqlDbType.Int,4)             
            ...
            parameters[4].Value = model.isstartusing;                        
...
SqlParameter[] parameters = {
            ...
            parameters[5].Value = model.isstartusing;                        
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from apush_token ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public System.Model.apush_token GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, token, device, clientType, customId, isstartusing  ");			
			strSql.Append("  from apush_token ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			System.Model.apush_token model=new System.Model.apush_token();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
																												...
																												if(ds.Tables[0].Rows[0]["clientType"].ToString()!="")
				{
					model.clientType=int.Parse(ds.Tables[0].Rows[0]["clientType"].ToString());
																												...
																												if(ds.Tables[0].Rows[0]["isstartusing"].ToString()!="")
				{
					model.isstartusing=int.Parse(ds.Tables[0].Rows[0]["isstartusing"].ToString());
				}
        ...
        public DataSet GetList(string strWhere, params SqlParameter[] parameters)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM apush_token T");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM apush_token T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parameters)
		{
			...
			strSql.Append(")AS Row, T.*  from apush_token T ");
