...
namespace System.DAL  
{
		...
		public partial class verification_code
	{
		...
		public int Add(System.Model.verification_code model)
		{
            ...
            strSql.Append("verificationMode,code,pudate,edate,type");
			strSql.Append(") values (");
            strSql.Append("@verificationMode,@code,@pudate,@edate,@type");            
            strSql.Append(") ");            
            strSql.Append(";select @@IDENTITY");		
			SqlParameter[] parameters = {
			            new SqlParameter("@verificationMode", SqlDbType.NVarChar,50) ,            
            ...
            parameters[0].Value = model.verificationMode;                        
		...
		public bool Update(System.Model.verification_code model)
		{
            ...
            strSql.Append(" verificationMode = @verificationMode , ");                                    
...
SqlParameter[] parameters = {
            ...
            parameters[1].Value = model.verificationMode;                        
		...
		public System.Model.verification_code GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, verificationMode, code, pudate, edate, type  ");			
			...
			System.Model.verification_code model=new System.Model.verification_code();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
												if(ds.Tables[0].Rows[0]["id"].ToString()!="")
				{
					model.id=int.Parse(ds.Tables[0].Rows[0]["id"].ToString());
																																				...
																																				model.verificationMode= ds.Tables[0].Rows[0]["verificationMode"].ToString();
        ...
        public DataSet GetList(string strWhere, params SqlParameter[] parameters)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM verification_code T");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM verification_code T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
