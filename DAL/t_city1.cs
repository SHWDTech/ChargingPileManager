...
namespace System.DAL  
{
		...
		public partial class t_city1
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from t_city1");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into t_city1(");			
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_city1 set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_city1 ");
			strSql.Append(" where id=@id ");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		public System.Model.t_city1 GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, provinceID, province  ");			
			strSql.Append("  from t_city1 ");
			strSql.Append(" where id=@id ");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
			...
			System.Model.t_city1 model=new System.Model.t_city1();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM t_city1 T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parameters)
		{
			...
			strSql.Append(")AS Row, T.*  from t_city1 T ");
