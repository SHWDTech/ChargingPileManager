...
namespace System.DAL  
{
		...
		public partial class t_content
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from t_content");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into t_content(");			
            strSql.Append("id,title,memo");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_content set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_content ");
			strSql.Append(" where id=@id ");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		public System.Model.t_content GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, title, memo  ");			
			strSql.Append("  from t_content ");
			strSql.Append(" where id=@id ");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
			...
			System.Model.t_content model=new System.Model.t_content();
        ...
        public DataSet GetList(string strWhere, params SqlParameter[] parameters)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.Append(" FROM t_content T");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM t_content T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parameters)
		{
			...
			strSql.Append(")AS Row, T.*  from t_content T ");
