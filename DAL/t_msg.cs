...
namespace System.DAL  
{
		...
		public partial class t_msg
	{
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("id", "t_msg");
        }
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from t_msg");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
		...
		public int Add(System.Model.t_msg model)
		{
            ...
            strSql.Append("title,memo,img,pudate");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_msg set ");
...
SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_msg ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public System.Model.t_msg GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id, title, memo, img, pudate  ");			
			strSql.Append("  from t_msg ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			System.Model.t_msg model=new System.Model.t_msg();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM t_msg T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parameters)
		{
			...
			strSql.Append(")AS Row, T.*  from t_msg T ");
