...
namespace System.DAL  
{
		...
		public partial class ispush
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from ispush");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
...
SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ispush ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM ispush T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parameters)
		{
			...
			strSql.Append(")AS Row, T.*  from ispush T ");
