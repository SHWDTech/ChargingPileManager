...
namespace System.DAL  
{
		...
		public partial class t_city2
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from t_city2");
			strSql.Append(" where ");
			                                       strSql.Append(" id = @id  ");
...
SqlParameter[] parameters = {
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_city2 ");
			strSql.Append(" where id=@id ");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM t_city2 T");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex, params SqlParameter[] parameters)
		{
			...
			strSql.Append(")AS Row, T.*  from t_city2 T ");
