<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_stipple.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_stipple" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            网点管理 <small><i class="icon-double-angle-right"></i>网点列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <img src="<%#DataBinder.Eval(Container.DataItem, "img")%>" height="50" />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <%# Utility.Helper.gerInt( DataBinder.Eval(Container.DataItem, "statuses"))==1 ?"在线":"离线" %>
                                                                        </td>
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "pudate")%>
                                                                        </td>
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_facility.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <i class="icon-download bigger-130" title="设备列表"></i></a><a class="green" style="text-decoration: none"
                                                                                    href="admin_stipple_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                    <i class="icon-pencil bigger-130" title="编辑"></i></a><a class="red" style="text-decoration: none"
                                                                                        href="javascript:if(confirm('确定要删除吗?'))window.location='admin_stipple.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row"
                                                                                style="width: 25px;">
                                                                                <div class="ui-pg-div">
                                                                                    <a href="admin_stipple_edit.aspx" style="text-decoration: none"><span class="ui-icon icon-plus-sign purple"
                                                                                        title="新增"></span></a>
                                                                                </div>
                                                                            </td>
