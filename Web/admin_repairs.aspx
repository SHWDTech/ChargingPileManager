<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_repairs.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_repairs" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            设备报修 <small><i class="icon-double-angle-right"></i>报修列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <%# typenames(  Utility.Helper.gerString( DataBinder.Eval(Container.DataItem, "types")))%>
                                                                        </td>
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "cause")%>
                                                                        </td>
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_repairs_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <i class="icon-pencil bigger-130" title="详情"></i></a><a class="red" style="text-decoration: none"
                                                                                    href="javascript:if(confirm('确定要删除吗?'))window.location='admin_repairs.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'">
