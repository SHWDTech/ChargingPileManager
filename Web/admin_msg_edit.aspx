<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="admin_msg_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_msg_edit" %>
    ...
    <script type="text/javascript">
        ...
        function g_AjxUploadImg(btn, img, hidPut) {
            ...
            new AjaxUpload(button, {
                action: 'Json/uploadmsgimg.aspx?filetowname=msgimg',
                data: {},
                name: 'file',
                onSubmit: function (file, ext) {
                    if (!(ext && /^(jpg|JPG|png|PNG|gif|GIF)$/.test(ext))) {
                        lay("您上传的图片格式不对，请重新选择！");
                        return false;
                    }

                },
                onComplete: function (file, response) {
                    var flagValue = jQuery.parseJSON(response);
                    if (flagValue.res == "1") {
                        hidPut.value = flagValue.Data[0].datafilename;
                        img.src = flagValue.Data[0].datafilename;
                        //alert("图片修改成功！");
                    } else if (flagValue.result == "2") {
                        alert(flagValue.msg);
                    } else if (flagValue.result == "0") {
                        alert("图片上传失败！");
                    }
                }
            });
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            消息管理 <small><i class="icon-double-angle-right"></i>编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox runat="server" ID="txtTitle" placeholder=" 标题" class="col-xs-10 col-sm-5"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <img runat="server" id="images" src="/img/moremg.jpg" alt="Alternate Text" />
                                    <br />
                                    <br />
                                    <input type="button" id="btnimg" value="修改图片" />
                                    <input type="hidden" runat="server" id="hidImgName" name="name" value="/img/moremg.jpg" />
                                    550*250
                                </div>
                            </div>
                            <div class="space-4">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group">
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="fckContent" class="col-xs-10 col-sm-5" Style="width: 85%;
                                                height: 300px; visibility: hidden; top: 0px; left: 0px;" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
