<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_facility.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_facility" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            充电桩管理 <small><i class="icon-double-angle-right"></i>充电桩列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                                ...
                                                <div class="dataTables_wrapper" role="grid">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th class="center">
                                                                    选择<%--<label><asp:CheckBox runat="server" id="controlAll"/></label>--%>
                                                                </th>
                                                                <th>
                                                                    类型
                                                                </th>
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "stipplename")%>
                                                                        </td>
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "identitycode")%>
                                                                        </td>
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "no")%>
                                                                        </td>
                                                                        <td>
                                                                            <%# Utility.Helper.gerInt( DataBinder.Eval(Container.DataItem, "statuses"))==1 ?"可用":"不可用" %>
                                                                        </td>
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "pudate")%>
                                                                        </td>
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_port.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <i class="icon-download bigger-130" title="接口列表"></i></a><a class="green" style="text-decoration: none"
                                                                                    href="admin_facility_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                    <i class="icon-pencil bigger-130" title="编辑"></i></a><a class="red" style="text-decoration: none"
                                                                                        href="javascript:if(confirm('确定要删除吗?'))window.location='admin_facility.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'">
                                                                                        <i class="icon-trash bigger-130" title="删除"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
                                                    ...
                                                    <div class="row" runat="server" id="divYes" style="display: block">
                                                        <div class="col-sm-6">
                                                            <div class="dataTables_info" style="padding-top: 5px;">
                                                                <table cellspacing="0" cellpadding="0" border="0" class="ui-pg-table navtable" style="float: left;
                                                                    table-layout: auto;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row"
                                                                                style="width: 25px;">
                                                                                <div class="ui-pg-div">
                                                                                    <a href="admin_facility_edit.aspx" style="text-decoration: none"><span class="ui-icon icon-plus-sign purple"
                                                                                        title="新增"></span></a>
                                                                                </div>
                                                                            </td>
                                                                            <td class="ui-pg-button ui-corner-all" title="" id="del_grid-table" data-original-title="Delete selected row"
                                                                                style="width: 25px;">
                                                                                <div class="ui-pg-div">
                                                                                    <span class="ui-icon icon-trash red" onclick="if(confirm('确定要删除吗?'))__doPostBack('btnDel','')"
                                                                                        title="删除"></span>
