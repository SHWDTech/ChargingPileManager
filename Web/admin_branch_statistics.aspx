<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_branch_statistics.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_branch_statistics" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            网点订单统计 <small><i class="icon-double-angle-right"></i>统计列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
