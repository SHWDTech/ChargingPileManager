<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_feedback.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_feedback" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            常见问题管理 <small><i class="icon-double-angle-right"></i>问题列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_feedback_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <i class="icon-pencil bigger-130" title="编辑"></i></a><a class="red" style="text-decoration: none"
                                                                                    href="javascript:if(confirm('确定要删除吗?'))window.location='admin_pt_message.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row"
                                                                                style="width: 25px;">
                                                                                <div class="ui-pg-div">
                                                                                    <a href="admin_feedback_edit.aspx" style="text-decoration: none"><span class="ui-icon icon-plus-sign purple"
                                                                                        title="新增"></span></a>
                                                                                </div>
                                                                            </td>
