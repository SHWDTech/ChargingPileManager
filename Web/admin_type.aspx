<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_type.aspx.cs" Inherits="ZDEnterprise.Web.admin_type" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            类型管理 <small><i class="icon-double-angle-right"></i>类型列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "tyoe")%>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <%#  Utility.Helper.gerDecimal( DataBinder.Eval(Container.DataItem, "discount"))*100%>%
                                                                        </td>
                                                                        <td>
                                                                            <%#DataBinder.Eval(Container.DataItem, "pudate")%>
                                                                        </td>
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_type_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <i class="icon-pencil bigger-130" title="编辑"></i></a><a class="red" style="text-decoration: none"
                                                                                    href="javascript:if(confirm('确定要删除吗?'))window.location='admin_type.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row"
                                                                                style="width: 25px;">
                                                                                <div class="ui-pg-div">
                                                                                    <a href="admin_type_edit.aspx" style="text-decoration: none"><span class="ui-icon icon-plus-sign purple"
                                                                                        title="新增"></span></a>
                                                                                </div>
                                                                            </td>
