<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="personal.aspx.cs" Inherits="ZDEnterprise.Web.personal" %>
							...
							<div class="col-xs-12">
								...
								<asp:UpdatePanel runat="server" ID="UpdatePanel1"><ContentTemplate>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtName"  placeholder=" 用户姓名" class="col-xs-10 col-sm-5" ></asp:TextBox>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox readonly runat="server" ID="txtCode"  placeholder=" 登录帐号" class="col-xs-10 col-sm-5" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox readonly runat="server" ID="txtRole"  placeholder=" 用户角色" class="col-xs-10 col-sm-5" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtPhone"  placeholder=" 联系电话" class="col-xs-10 col-sm-5" ></asp:TextBox>
									...
									<div runat="server" id="divSj" style=" display:none">
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商家类型 </label>

										<div class="col-sm-9">
											<asp:TextBox readonly runat="server" ID="txtLx"  placeholder=" 商家类型" class="col-xs-10 col-sm-5" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商家地址 </label>

										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtAdress"  placeholder=" 商家地址" class="col-xs-10 col-sm-5" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商家经度 </label>

										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtJd"  placeholder=" 商家经度" class="col-xs-10 col-sm-5" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商家纬度 </label>

										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtWd"  placeholder=" 商家纬度" class="col-xs-10 col-sm-5" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商家介绍 </label>

										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtJs"  placeholder=" 商家介绍" class="col-xs-10 col-sm-5" TextMode="MultiLine" Height="80"></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                                    <div class="ace-file-input " style=" width:41.6666%">
													<asp:FileUpload runat="server" ID="fileLogo"  onchange="sc()"  />
													<label class="file-label" data-title="Choose" onclick="document.form1.fileLogo.click();"><span class="file-name"><asp:Label runat="server" ID="lblFlie" Text="No File ..."></asp:Label><i class="icon-upload-alt"></i></span></label>
													</div>
													<script>
													    function sc() {
													        var file = $("#fileLogo").val();
													        var fileName = getFileName(file);
													        var hz = getFileExt(fileName);
													       
													        if(hz==".jpg" || hz==".png")
													        {
													           $("#lblFlie").text(fileName);
													        }
													        else
													        {
													           $("#lblFlie").text("No File ...");
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:Image runat="server" ID="imgLogo" Width="100" Height="100" />
											<asp:HiddenField runat="server" ID="hidImg" />
										</div>
									</div>
									
									<div runat="server" id="divHb" style=" display:none">
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 上传海报 </label>

										<div class="col-sm-9">
                                                    <div class="ace-file-input " style=" width:41.6666%">
													<asp:FileUpload runat="server" ID="fileLogo2"  onchange="sc2()"  />
													<label class="file-label" data-title="Choose" onclick="document.form1.fileLogo2.click();"><span class="file-name"><asp:Label runat="server" ID="lblFlie2" Text="No File ..."></asp:Label><i class="icon-upload-alt"></i></span></label>
													</div>
													<script>
													    function sc2() {
													        var file = $("#fileLogo2").val();
													        var fileName = getFileName(file);
													        var hz = getFileExt(fileName);

													        if (hz == ".jpg" || hz == ".png") {
													            $("#lblFlie2").text(fileName);
													        }
													        else {
													            $("#lblFlie2").text("No File ...");
													            alert("请选择jpg或者png格式的图片");
													        }
													    } 
													</script>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:Image runat="server" ID="imgLogo2" Width="60%"   />
											<asp:HiddenField runat="server" ID="hidImg2" />
										</div>
									</div>
									</div>
