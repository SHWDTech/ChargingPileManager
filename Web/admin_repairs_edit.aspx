<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_repairs_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_repairs_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            报修管理 <small><i class="icon-double-angle-right"></i>报修详情 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="infotexts" id='member_p' runat="server">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="infotexts" id='type_p' runat="server">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="infotexts" id='cause_p' runat="server">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="space-4">
