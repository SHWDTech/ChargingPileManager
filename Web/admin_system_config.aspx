<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_system_config.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_system_config" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            系统配置管理 <small><i class="icon-double-angle-right"></i>编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtTel" placeholder=" 客服电话" class="col-xs-10 col-sm-5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=" *"
                                                ControlToValidate="txtTel"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <img src="" width="300" id="appImg" runat="server" alt="图片丢失" /><br />
                                            <br />
                                            <input type="button" id="btnimg" value="修改图片" />
                                            <input type="hidden" id="hidImgName" name="name" value="" />
                                            1920x1080
                                        </div>
                                    </div>
                                    <div class="space-4">
