<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="admin_pt_content_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_pt_content_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            内容管理 <small><i class="icon-double-angle-right"></i>编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="fckContent" class="col-xs-10 col-sm-5" Style="width: 85%;
                                                height: 300px; visibility: hidden;" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
