...
namespace Com.Alipay
{
    ...
    public class Submit
    {
        ...
        private static string BuildRequestMysign(Dictionary<string, string> sPara, string key2)
        {
            ...
            {
                case "MD5":
                    mysign = AlipayMD5.Sign(prestr, (key2 == "" ? _key : key2), _input_charset);
                    break;
                case "RSA":
        ...
        private static Dictionary<string, string> BuildRequestPara(Dictionary<string, string> sParaTemp, string key2)
        {
            //待签名请求参数数组
            ...
            //获得签名结果
            mysign = BuildRequestMysign(sPara, key2);
        ...
        private static string BuildRequestParaToString(Dictionary<string, string> sParaTemp, Encoding code, string key2)
        {
            //待签名请求参数数组
            Dictionary<string, string> sPara = new Dictionary<string, string>();
            sPara = BuildRequestPara(sParaTemp, key2);
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string strButtonValue, string key2)
        {
            //待请求参数数组
            Dictionary<string, string> dicPara = new Dictionary<string, string>();
            dicPara = BuildRequestPara(sParaTemp, key2);
        ...
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string key2)
        {
            Encoding code = Encoding.GetEncoding(_input_charset);

            //待请求参数数组字符串
            string strRequestData = BuildRequestParaToString(sParaTemp, code, key2);
        ...
        /// <returns>支付宝处理结果</returns>
        public static string BuildRequest(string GATEWAY_NEW, Dictionary<string, string> sParaTemp, string strMethod, string fileName, byte[] data, string contentType, int lengthFile, string key2)
        {
