<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_stipple_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_stipple_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            网点管理 <small><i class="icon-double-angle-right"></i>新增/编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtname" placeholder=" 名称" class="col-xs-10 col-sm-5"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtreferral" placeholder=" 介绍" class="col-xs-10 col-sm-5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" *"
                                                ControlToValidate="txtreferral"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtlongitude" placeholder=" 经度" class="col-xs-10 col-sm-5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=" *"
                                                ControlToValidate="txtlongitude"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtlatitude" placeholder=" 纬度" class="col-xs-10 col-sm-5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage=" *"
                                                ControlToValidate="txtlatitude"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:DropDownList runat="server" ID="ddlstatuses" class="form-control col-sm-5" Style="width: 41.6666%">
                                                <asp:ListItem Value="1">在线</asp:ListItem>
                                                <asp:ListItem Value="0">离线</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage=" *"
                                                ControlToValidate="ddlstatuses"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            所属城市</label>
                                        <div class="col-sm-9">
                                            <asp:DropDownList runat="server" ID="city1" class="form-control col-sm-5" Style="width: 13.6666%"
                                                AutoPostBack="True" OnSelectedIndexChanged="city1_SelectedIndexChanged">
                                                <asp:ListItem Value="">--请选择省--</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage=" *"
                                                ControlToValidate="city1"></asp:RequiredFieldValidator>
                                            <asp:DropDownList runat="server" ID="city2" class="form-control col-sm-5" Style="width: 13.6666%"
                                                AutoPostBack="True" OnSelectedIndexChanged="city2_SelectedIndexChanged">
                                                <asp:ListItem Value="">--请选择市--</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage=" *"
                                                ControlToValidate="city2"></asp:RequiredFieldValidator>
                                            <asp:DropDownList runat="server" ID="city3" class="form-control col-sm-5" Style="width: 14.3%"
                                                AutoPostBack="True" OnSelectedIndexChanged="city3_SelectedIndexChanged">
                                                <asp:ListItem Value="">--请选择区--</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage=" *"
                                                ControlToValidate="city3"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="ace-file-input " style="width: 41.6666%">
                                                ...
                                                <label class="file-label" data-title="Choose" onclick="document.form1.fileLogo.click();">
                                                    <span class="file-name">
                                                        <asp:Label runat="server" ID="lblFlie" Text="No File ..."></asp:Label><i class="icon-upload-alt"></i></span></label>
                                            </div>
                                            <script>
                                                function sc() {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:Image runat="server" ID="imgLogo" Width="340" />
                                ...
                                <Triggers>
                                    <asp:PostBackTrigger ControlID="btnBc" />
                                </Triggers>
                            </asp:UpdatePanel>
                            </form>
                        </div>
