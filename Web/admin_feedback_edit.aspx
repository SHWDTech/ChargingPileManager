<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="admin_feedback_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_feedback_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            常见问题管理 <small><i class="icon-double-angle-right"></i>新增/编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
