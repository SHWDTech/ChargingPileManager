<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="admin_web_img_add.aspx.cs" Inherits="ZDEnterprise.Web.admin_web_img_add" %>
								...
								<asp:UpdatePanel runat="server" ID="UpdatePanel1"><ContentTemplate>
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<asp:DropDownList runat="server" ID="ddlLx" class="col-xs-10 col-sm-5" >
											<asp:ListItem Value="">请选择跳转类型</asp:ListItem>
											<asp:ListItem Value="1">跳转到商品</asp:ListItem>
											<asp:ListItem Value="2">跳转到商家</asp:ListItem>
											</asp:DropDownList>
											<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage=" *" ControlToValidate="ddlLx"></asp:RequiredFieldValidator>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 商家ID/商品ID </label>

										<div class="col-sm-9">
											<asp:TextBox  runat="server" ID="txtId"  placeholder=" 商家ID/商品ID" class="col-xs-10 col-sm-5" ></asp:TextBox> 
											<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=" *" ControlToValidate="txtId"></asp:RequiredFieldValidator>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
													...
													<label class="file-label" data-title="Choose" onclick="document.form1.fileLogo.click();"><span class="file-name"><asp:Label runat="server" ID="lblFlie" Text="No File ..."></asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" *" ControlToValidate="fileLogo"></asp:RequiredFieldValidator><i class="icon-upload-alt"></i></span></label>
													</div>
													<script>
													    function sc() {
