<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_user_statistics.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_user_statistics" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            查看会员 <small><i class="icon-double-angle-right"></i>会员列表 </small>
                                                ...
                                                <div class="dataTables_wrapper" role="grid">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        <td align="center">
                                                                            <%--<img src="<%# VirturlPath + (DataBinder.Eval(Container.DataItem, "img").ToString() == "" ? "/Upload/logo/photo.png" : DataBinder.Eval(Container.DataItem, "img").ToString())%>"
                                                                                width="36" height="40" />--%>
                                                                            <img src="/Upload/logo/photo.png" width="36" height="40" />
                                                                        </td>
                                                                        <td>
														...
														<td><%#DataBinder.Eval(Container.DataItem, "nicheng")%></td>--%>
                                                                        ...
                                                                        <%--<td><%#getAdress(DataBinder.Eval(Container.DataItem, "id").ToString())%></td>
													    <td><a href="admin_custom_money.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">￥<%# Convert.ToDouble(DataBinder.Eval(Container.DataItem, "syMoney")).ToString()%></a></td>
													    <td><a href="admin_custom_jf.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"><%#DataBinder.Eval(Container.DataItem, "syJf")%></a></td>--%>
                                                                        <td>
