<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="admin_pt_message_edit.aspx.cs" Inherits="ZDEnterprise.Web.admin_pt_message_edit" %>
								...
								<asp:UpdatePanel runat="server" ID="UpdatePanel1"><ContentTemplate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage=" *" ControlToValidate="txtTitle"></asp:RequiredFieldValidator>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox  runat="server" ID="txtMemo"  placeholder=" 内容" class="col-xs-10 col-sm-5" TextMode="MultiLine" Height="80" ></asp:TextBox> 
											<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" *" ControlToValidate="txtMemo"></asp:RequiredFieldValidator>
										</div>
									</div>
									<div class="space-4"></div>
