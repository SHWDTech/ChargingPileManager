<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_pt_content.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_pt_content" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            内容管理 <small><i class="icon-double-angle-right"></i>内容列表 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_pt_content_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <i class="icon-pencil bigger-130" title="编辑"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
