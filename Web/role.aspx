<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role.aspx.cs" Inherits="ZDEnterprise.Web.role" %>
...
<asp:Repeater ID="rptDetail" runat="server">
 <ItemTemplate>
													<tr>
														...
														<asp:Label ID="lblId" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem, "roleId")%>'></asp:Label>
														</label></td>
														
														<td><%#DataBinder.Eval(Container.DataItem, "name")%></td>
														<td><%#DataBinder.Eval(Container.DataItem, "pudate")%></td>

														<td>
														        <a class="blue"  style=" text-decoration:none" href="role_qx.aspx?id=<%#DataBinder.Eval(Container.DataItem, "roleId")%>"><i class="icon-lock bigger-130" title="权限分配"></i></a>
																<a class="green"  style=" text-decoration:none" href="role_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "roleId")%>"><i class="icon-pencil bigger-130" title="编辑"></i></a>
																<a class="red"  style=" text-decoration:none" href="javascript:if(confirm('确定要删除吗?'))window.location='role.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "roleId")%>'"><i class="icon-trash bigger-130" title="删除"></i></a>
														</td>
													</tr>
</ItemTemplate>
</asp:Repeater>
											    ...
											    <tbody>
											     <tr>
											      <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row" style=" width:25px;">
											        <div class="ui-pg-div"><a href="role_add.aspx" style=" text-decoration:none"><span class="ui-icon icon-plus-sign purple" title="新增"></span></a></div>
											       </td>
