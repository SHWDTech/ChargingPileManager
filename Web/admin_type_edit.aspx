<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_type_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_type_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            类型管理 <small><i class="icon-double-angle-right"></i>新增/编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group" runat="server" id="nohezi">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txttyoe" placeholder=" 类型名称" class="col-xs-10 col-sm-5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" *"
                                                ControlToValidate="txttyoe"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    <div class="form-group" runat="server" id="Div2">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txttime" placeholder=" 充电时长" class="col-xs-10 col-sm-5"></asp:TextBox>
                                    ...
                                    <div class="form-group" runat="server" id="Div3">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtprice" placeholder=" 价格/原价" class="col-xs-10 col-sm-5"></asp:TextBox>
                                    ...
                                    <div class="form-group" runat="server" id="Div4">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtdiscount" placeholder="  折扣" class="col-xs-10 col-sm-5"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage=" *"
                                                ControlToValidate="txtdiscount"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
