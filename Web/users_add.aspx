<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="users_add.aspx.cs" Inherits="ZDEnterprise.Web.users_add" %>
							...
							<div class="col-xs-12">
								...
								<asp:UpdatePanel runat="server" ID="UpdatePanel1"><ContentTemplate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtCode"  placeholder=" 登录帐号" class="col-xs-10 col-sm-5" ></asp:TextBox>
											 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage=" *" ControlToValidate="txtCode"></asp:RequiredFieldValidator>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtPwd"  placeholder=" 登录密码" class="col-xs-10 col-sm-5" TextMode="Password" ></asp:TextBox>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:DropDownList runat="server" ID="ddlRole" class="form-control col-sm-5"  style=" width:41.6666%"></asp:DropDownList>
											 <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage=" *" ControlToValidate="ddlRole"></asp:RequiredFieldValidator>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
