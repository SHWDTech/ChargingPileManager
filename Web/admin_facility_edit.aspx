<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_facility_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_facility_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            充电桩管理 <small><i class="icon-double-angle-right"></i>新增/编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group" runat="server" id="nohezi">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtno" placeholder=" 充电桩标识(identitycode)" class="col-xs-10 col-sm-5"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:DropDownList runat="server" ID="ddltype" class="form-control col-sm-5" Style="width: 41.6666%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:DropDownList runat="server" ID="ddlfid" class="form-control col-sm-5" Style="width: 41.6666%">
                                                <asp:ListItem Value="">--请选择网点--</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage=" *"
                                                ControlToValidate="ddlfid"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
