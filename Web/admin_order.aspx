<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_order.aspx.cs" Inherits="ZDEnterprise.Web.admin_order" %>
                                                            ...
                                                            <asp:Repeater ID="rptDetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a class="green" style="text-decoration: none" href="admin_order_info.aspx?id=<%#DataBinder.Eval(Container.DataItem, "serialNumber")%>">
