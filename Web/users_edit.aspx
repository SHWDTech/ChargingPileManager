<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest ="false"  CodeBehind="users_edit.aspx.cs" Inherits="ZDEnterprise.Web.users_edit" %>
							...
							<div class="col-xs-12">
								...
								<asp:UpdatePanel runat="server" ID="UpdatePanel1"><ContentTemplate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<asp:TextBox runat="server" ID="txtPwd"  placeholder=" 为空时不修改密码" class="col-xs-10 col-sm-5" TextMode="Password" ></asp:TextBox>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
