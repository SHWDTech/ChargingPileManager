<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_pt_message.aspx.cs" Inherits="ZDEnterprise.Web.admin_pt_message" %>
 ...
 <ItemTemplate>
													<tr>
														...
														<td>
																...
																<a class="green"  style=" text-decoration:none" href="admin_pt_message_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"><i class="icon-pencil bigger-130" title="编辑"></i></a>
																<a class="red"  style=" text-decoration:none" href="javascript:if(confirm('确定要删除吗?'))window.location='admin_pt_message.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'"><i class="icon-trash bigger-130" title="删除"></i></a>
														</td>
													</tr>
</ItemTemplate>
</asp:Repeater>
											    ...
											    <tbody>
											     <tr>
											      <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row" style=" width:25px;">
											        <div class="ui-pg-div"><a href="admin_pt_message_add.aspx" style=" text-decoration:none"><span class="ui-icon icon-plus-sign purple" title="新增"></span></a></div>
											       </td>
