<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_port_edit.aspx.cs"
    Inherits="ZDEnterprise.Web.admin_port_edit" %>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="page-header">
                        <h1>
                            充电枪管理 <small><i class="icon-double-angle-right"></i>新增/编辑 </small>
                        </h1>
                    </div>
                    <!-- /.page-header -->
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                <ContentTemplate>
                                    <div class="form-group" runat="server" id="nohezi">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            充电枪标识
                                        </label>
                                        <div class="col-sm-9">
                                            <asp:TextBox runat="server" ID="txtno" placeholder=" 充电枪标识(identitycode)" class="col-xs-10 col-sm-5"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            归属</label>
                                        <div class="col-sm-9">
                                            <asp:DropDownList runat="server" ID="stipple" class="form-control col-sm-5" Style="width: 20.6666%"
                                                AutoPostBack="True" OnSelectedIndexChanged="city1_SelectedIndexChanged">
                                                <asp:ListItem Value="">--请选择网点--</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage=" *"
                                                ControlToValidate="stipple"></asp:RequiredFieldValidator>
                                            <asp:DropDownList runat="server" ID="facility" class="form-control col-sm-5" Style="width: 20.6666%; top: 0px; left: 0px;"
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage=" *"
                                                ControlToValidate="facility"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="space-4">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <img src="" runat="server" id="imgqrimg" width="150" height="150" />
                                        </div>
                                    </div>
