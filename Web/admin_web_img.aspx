<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_web_img.aspx.cs" Inherits="ZDEnterprise.Web.admin_web_img" %>
...
<asp:Repeater ID="rptDetail" runat="server">
 <ItemTemplate>
													<tr>
														...
														<td><img src="<%#VirturlPath+DataBinder.Eval(Container.DataItem, "img")%>" height="80" /></td>
										                <td><%#DataBinder.Eval(Container.DataItem, "lx").ToString() == "1" ? "跳转到商品" : "跳转到商家"%></td> 
														<td><%#DataBinder.Eval(Container.DataItem, "tzId")%></td> 
														<td><%#DataBinder.Eval(Container.DataItem, "pudate")%></td>

														<td>
														  
																<a class="green"  style=" text-decoration:none" href="admin_web_img_edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>"><i class="icon-pencil bigger-130" title="编辑"></i></a>
																<a class="red"  style=" text-decoration:none" href="javascript:if(confirm('确定要删除吗?'))window.location='admin_web_img.aspx?m=del&id=<%#DataBinder.Eval(Container.DataItem, "id")%>'"><i class="icon-trash bigger-130" title="删除"></i></a>
														</td>
													</tr>
</ItemTemplate>
</asp:Repeater>
											    ...
											    <tbody>
											     <tr>
											      <td class="ui-pg-button ui-corner-all" title="" id="add_grid-table" data-original-title="Add new row" style=" width:25px;">
											        <div class="ui-pg-div"><a href="admin_web_img_add.aspx" style=" text-decoration:none"><span class="ui-icon icon-plus-sign purple" title="新增"></span></a></div>
											       </td>
